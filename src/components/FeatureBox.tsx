...
import imageTwo from '../assets/peeling-useless-parts-jewelry.jpg'; // Update with the path to your image
    ...
    return (
        ...
        <div className="row justify-content-center">
            ...
            <div className='hr-line-container'>
                ...
                <p className='text-grey-light'>Making Compliance Easy for the diamond industry. We do this by combining our extensive knowledge of regulatory frameworks with cutting-edge technology. Our aim is to provide a secure foundation for trading, allowing our clients to operate confidently in a world that has growing demands for the utmost in accountability and transparency.</p>
